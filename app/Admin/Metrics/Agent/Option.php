...
//        $this->handle(request());
    ...
    public function handle(Request $request)
    {
        ...
        $builder12 =
        $builder13 =
             OptionSceneOrder::query()->whereHas('user',function ($q)use($baseAgentIds){$q->whereIn('referrer',$baseAgentIds);})->where(['bet_coin_id'=>$coin_id]);
...
<div class="d-flex p-1 flex-column justify-content-between" style="padding-top: 0;width: 100%;height: 100%;min-height: {$minHeight}">
    ...
    <a href="/admin/option-order?referrer={$referrer}" class="btn btn-primary shadow waves-effect waves-light">View Details <i class="feather icon-chevrons-right"></i></a>
</div>
HTML
        );
    }
