...
$api->group(['namespace' => 'V1','middleware'=>'auth.api'], function ($api) {
    ...
    $api->post('user/sendSmsCodeAuth','UserController@sendSmsCodeAuth');//注册发送短信验证码
...
//        });
    ...
    $api->get('wallet/currencyList','UserWalletController@currencyList');
...
$api->group(['namespace' => 'V1'], function ($api) {
    // 获取最新行情
    $api->get('contract/contractnewAccount','ContractController@contractnewAccount');
